...
-- 3. Restrict vehicle bookings to authenticated users only
...
-- 4. Restrict fleet vehicles to authenticated users
...
-- 5. Add rate limiting function for satisfaction surveys
